...
export type SceneWhereInput = {
  ...
  result?: Prisma.StringFilter<"Scene"> | string
...
export type SceneScalarWhereWithAggregatesInput = {
  ...
  result?: Prisma.StringWithAggregatesFilter<"Scene"> | string
...
export type SceneOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "prompt" | "result" | "createdAt", ExtArgs["result"]["scene"]>
...
export interface SceneFieldRefs {
  ...
  readonly result: Prisma.FieldRef<"Scene", 'String'>
